...
impl Plugin for ActionPanelPlugin {
    fn build(&self, app: &mut bevy::prelude::App) {
        app.add_systems(Startup, layout::setup_buttons)
            ...
            .add_systems(Update, (interaction::handle_dbg_button_click, interaction::handle_move_button_click, interaction::hire_army_button_click, interaction::handle_finish_moves_in_round_button_click).in_set(UpdateUI::UserInput))
