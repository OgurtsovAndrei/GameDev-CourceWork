...
use crate::world::actions::spawn_menu::systems::interactions::{interact_cancel_button_click, interact_with_end_spawn_button, interact_with_spawn_battleship_button, interact_with_spawn_destroyer_button};
    ...
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(Update, (
                ...
                interact_with_spawn_destroyer_button,
                interact_with_spawn_battleship_button,
